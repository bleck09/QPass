...
// W1 — recaudación por entradas por día
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={puntos} margin={{ top: 8, right: 12, bottom: 4, left: 4 }}>
          ...
          <Tooltip contentStyle={tooltipStyle} formatter={(v) => [fmtBs(v), 'Recaudado']} labelFormatter={(l) => l} />
          <Line type="monotone" dataKey="monto" stroke="var(--viz-serie-1)" strokeWidth={2} dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </PanelGrafico>
  );
