/* ============================================================================
 * DevolucionPage (/devolucion) — escanea la manilla y registra el retiro de
 * saldo. La foto del carnet de quien retira es obligatoria.
 * ========================================================================= */
...
export function DevolucionPage() {
  ...
  const onSubmit = (v: Values) => {
    if (!entrada || entrada.usuarioId == null || !fotoCarnet) return;
    devolver.mutate(
      {
